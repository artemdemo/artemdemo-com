 ...
 */var n=r(72),i=r(75),o=r(74),a=r(73),s=r(132),c=r(96);t.exports=n("remark-lint:no-duplicate-headings",function(t,e){var r={};a(t,"heading",function(t){var n,a;o(t)||(n=c(t).toUpperCase(),(a=r[n])&&"heading"===a.type&&e.message(l+" ("+s(i.start(a))+")",t),r[n]=t)})});var l="Do not use headings with similar content"},function(t,e,r){"use strict";
/**
 * @author Titus Wormer
 * @copyright 2015 Titus Wormer
 * @license MIT
 ...
 */var n=r(72),i=r(73),o=r(75).start,a=r(74),s=r(132);t.exports=n("remark-lint:no-multiple-toplevel-headings",function(t,e,r){var n,c=r||1;i(t,"heading",function(t){a(t)||t.depth!==c||(n?e.message("Don’t use multiple top level headings ("+n+")",t):n=s(o(t)))})})},function(t,e,r){"use strict";
/**
 * @author Titus Wormer
 * @copyright 2015 Titus Wormer
 * @license MIT
